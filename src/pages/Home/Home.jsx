...
const Home = () => {
    ...
    return (
        ...
        <div>
            <HSlider />
            <HomeCategory title="Categories" btntitle="more" pathText='/allcategory'/>
            <CardProductContainer title="Top Sellers" btntitle="show more" pathText='/product-tshop'/>
            <DescountSlide />
            <CardProductContainer title="Latest Fashion" btntitle="show more" /> {/* pathText='/produc-tshop' */}
